...
export default function Conexoes() {
    return (
        <section id="conexoes" style={{ backgroundColor: '#F9F2EC' }} className="py-20 px-6">
            <div className="max-w-6xl mx-auto">

                {/* Título */}
                <div className="flex justify-center mb-14">
                    <div className=" rounded-2xl px-14 py-4 bg-#F9F2EC">
                ...
                <div className="flex flex-col gap-8">
                    {conexoes.map((c) => (
                        <div key={c.nome} className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            {/* Col 1 — Foto */}
                            <div className="relative rounded-2xl overflow-hidden  min-h-72 p-4 shadow-sm bg-[#F9F2EC]">
                                <img
                                    src={c.imagem}
                                    alt={c.nome}
                            ...
                            {/* Col 2 — Texto 1 */}
                            <div className="bg-#F9F2EC rounded-2xl p-7 ">
