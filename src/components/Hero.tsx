    ...
    return (
        <section className="relative min-h-screen w-full">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center px-4 pt-24 pb-10 text-center sm:px-6">
                ...
                <div className="mb-5 flex w-full max-w-6xl items-center justify-center gap-4 sm:mb-6 sm:gap-10">
                ...
                <p className="mb-8 max-w-xs text-[10px] font-medium uppercase tracking-[0.22em] text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] font-mirza sm:mb-12 sm:max-w-2xl sm:text-xs sm:tracking-[0.3em]">
